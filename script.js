...
function setupReservation() {
    ...
    if (!form) return;
    const RESTAURANT_PHONE = "38345632635"; // Zëvendëso me numrin real të Tavernës Gegë
...
function setupFloatWA() {
    ...
    if (btn) {
        btn.addEventListener("click", (e) => {
            e.preventDefault();
            window.open("https://wa.me/38345632635?text=Përshëndetje!%20Dua%20të%20rezervoj%20një%20tryezë.", "_blank");
        });
    }
}
